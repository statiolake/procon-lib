        ...
        public:
            class safe_iota_end_iterator {
                private:
                    T m_value;
                public:
                    friend bool safe_iota_iterator::operator!=(safe_iota_end_iterator const &);
                    friend bool safe_iota_iterator::operator==(safe_iota_end_iterator const &);
                    safe_iota_end_iterator(T value) : m_value(value) {}
            ...
            class safe_iota_iterator {
                private:
                    T m_value, m_step;
                public:
                    safe_iota_iterator(T value, T step) : m_value(value), m_step(step) {}
            ...
            safe_iota(T beg, T end, T step) : m_beg(beg), m_end(end), m_step(step), m_curr(beg) {}

            safe_iota_iterator begin() {
                return safe_iota_iterator(m_beg, m_step);
            }

            safe_iota_end_iterator end() {
                return safe_iota_end_iterator(m_end);
            }
    };
